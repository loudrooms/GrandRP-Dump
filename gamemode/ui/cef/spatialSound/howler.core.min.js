...
(function () {
    ...
    _setup: function () {
      ...
      if (!e.usingWebAudio) {
        if (typeof Audio != "undefined") {
          try {
            var o = new Audio();
            if (o.oncanplaythrough === undefined) {
  ...
  o.prototype = {
    ...
    volume: function () {
      ...
      if (r.length === 1 || r.length === 2 && r[1] === undefined) {
      ...
      for (var u = 0; u < o.length; u++) {
        if (a = t._soundById(o[u])) {
          a._volume = e;
          if (!r[2]) {
            t._stopFade(o[u]);
          }
          if (t._webAudio && a._node && !a._muted) {
            a._node.gain.setValueAtTime(e, n.ctx.currentTime);
          } else if (a._node && !a._muted) {
    ...
    rate: function () {
      ...
      for (var i = 0; i < o.length; i++) {
        if (d = t._soundById(o[i])) {
          ...
          d._rate = e;
          if (t._webAudio && d._node && d._node.bufferSource) {
            d._node.bufferSource.playbackRate.setValueAtTime(e, n.ctx.currentTime);
          } else if (d._node) {
            d._node.playbackRate = e;
          }
          var _ = t.seek(o[i]);
          var s = (t._sprite[d._sprite][0] + t._sprite[d._sprite][1]) / 1000 - _;
          var l = s * 1000 / Math.abs(d._rate);
          if (!!t._endTimers[o[i]] || !d._paused) {
            t._clearTimer(o[i]);
    ...
    seek: function () {
      ...
      if (d) {
        ...
        d._ended = false;
        t._clearTimer(o);
        if (!t._webAudio && !!d._node && !isNaN(d._node.duration)) {
